...
export {}
declare global {
  const DIFFICULTY_LABELS: typeof import('../../stores/exam').DIFFICULTY_LABELS
  const GRADE_LABELS: typeof import('../../stores/exam').GRADE_LABELS
  const SUBJECT_LABELS: typeof import('../../stores/exam').SUBJECT_LABELS
  const TYPE_LABELS: typeof import('../../stores/exam').TYPE_LABELS
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { QuestionType, Difficulty, Grade, Subject, Question, ExamConfig, ExamPaper, AnswerRecord, ExamResult } from '../../stores/exam'
  import('../../stores/exam')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly DIFFICULTY_LABELS: UnwrapRef<typeof import('../../stores/exam')['DIFFICULTY_LABELS']>
    readonly GRADE_LABELS: UnwrapRef<typeof import('../../stores/exam')['GRADE_LABELS']>
    readonly SUBJECT_LABELS: UnwrapRef<typeof import('../../stores/exam')['SUBJECT_LABELS']>
    readonly TYPE_LABELS: UnwrapRef<typeof import('../../stores/exam')['TYPE_LABELS']>
    ...
    readonly useExamStore: UnwrapRef<typeof import('../../stores/exam')['useExamStore']>
